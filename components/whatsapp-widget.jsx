...
const WhatsAppWidget = () => {
  ...
  return (
    <div className="relative z-[999999]">
      <div className={`${styles.whatsappBox} ${isActive ? styles.active : ""}`}>
        ...
        <div className={styles.chatBtnBox}>
          <div className={styles.chatBtn}>
            <a
              href="https://wa.me/+916392838207?text=Hello%20I%20Want%20To%20Know%20About%20Your%20Services"
              target="_blank"
      ...
      <div
        className={`${styles.whatsappStickyBtn} bg-[#00a884] p-4 rounded-full`}
